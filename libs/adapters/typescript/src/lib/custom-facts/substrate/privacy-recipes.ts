...
export const sharedPrivacyProcessorRecipes: readonly PrivacyProcessorRecipe[] = [
  {
...
export function matchSharedPrivacyProcessorRecipe(
  ...
  return sharedPrivacyProcessorRecipes.find((recipe) =>
