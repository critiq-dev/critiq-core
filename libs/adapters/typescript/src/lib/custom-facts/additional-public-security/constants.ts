...
export const FACT_KINDS = {
  ...
  pathJoinUserInput: 'security.path-join-user-input',
  expressInsecureListen: 'security.express-insecure-listen',
  ...
  userControlledRegexp: 'security.user-controlled-regexp',
